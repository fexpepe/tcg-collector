...
// As ÁREAS (prefixos de classe -> páginas) e as exceções que ficam no núcleo
// moram em scripts/lib/css-areas.mjs: o scripts/check.mjs lê a mesma tabela pra
// barrar página que desenha classe de uma área sem carregar a folha dela.
import { AREAS, FICA_NO_NUCLEO } from "./lib/css-areas.mjs";
