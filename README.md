...
- a página de detalhe (Pokémon/set/artista) tem um **filtro de raridade** multi-seleção que agrupa o vocabulário da TCGdex em buckets do colecionador — Comuns e raras (Common/Uncommon/Rare/Double Rare), Descontinuadas (Holo Rare, Rainbow/Hyper, Secret…), Ultra Rare, Illustration Rare e Special Illustration. Só aparecem os buckets presentes na página; raridades localizadas/não mapeadas caem em "Comuns e raras";
