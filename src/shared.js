(function () {
  ...
  const MESSAGES = {
    pt: {
      ...
      "type.steel": "Aço",
      "type.fairy": "Fada",
      "home.eyebrow": "Grátis · sem conta · em português",
      "home.title": "Sua coleção de Pokémon TCG, <span class=\"accent\">organizada</span>.",
      "home.sub": "Uma alternativa brasileira aos rastreadores pagos. Acompanhe cada carta por variante e quantidade — Holo, Reverse, 1st Edition — navegando por Pokédex, sets e artistas. Tudo direto no navegador: seus dados não saem daqui.",
      ...
      "home.feature4.body": "Sem anúncios, sem recursos travados, sem plano \"pro\".",
    ...
    en: {
      ...
      "type.steel": "Steel",
      "type.fairy": "Fairy",
      "home.eyebrow": "Free · no account · multilingual",
      ...
      "home.feature4.body": "No ads, no locked features, no \"pro\" plan.",
