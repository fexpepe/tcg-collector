(function () {
  ...
  const GAME_COLOR = { pokemon: "#e23030", lorcana: "#3f3d96", onepiece: "#d9a400", magic: "#2563eb", fab: "#0d9488", naruto: "#ea580c", hxh: "#15803d" };
  ...
  const GAME_LABEL_KEY = {
    ...
    fab: "filter.gameFab", naruto: "filter.gameNaruto", hxh: "filter.gameHxh"
  };
