...
window.TCG_MESSAGES = {
    pt: {
      ...
      "terms.title": "Termos de Uso - TCG Collector",
      "terms.heading": "Termos de Uso",
      "terms.updated": "Última atualização: junho de 2026.",
      "terms.s.intro": "<h2>Sobre estes termos</h2><p>O TCG Collector é um app gratuito para acompanhar coleções de Pokémon TCG. Ao usar o site, você concorda com estes termos — se não concordar, não use o serviço. O app é destinado a maiores de 13 anos; sendo menor de 18, use com a ciência de um responsável.</p>",
    ...
    en: {
      ...
      "terms.title": "Terms of Use - TCG Collector",
      "terms.heading": "Terms of Use",
      "terms.updated": "Last updated: June 2026.",
      "terms.s.intro": "<h2>About these terms</h2><p>TCG Collector is a free app to track Pokémon TCG collections. By using the site, you agree to these terms — if you don't agree, don't use the service. The app is intended for users 13 and older; if you're under 18, use it with a guardian's awareness.</p>",
