...
window.TCG_MESSAGES = {
    pt: {
      ...
      "privacy.s.cookies": "<h2>Cookies e rastreamento</h2><p>Não usamos cookies de rastreamento, pixels ou ferramentas de analytics de terceiros. O app guarda dados só no <strong>localStorage/IndexedDB</strong> do seu navegador, para funcionar — não para te rastrear entre sites.</p>",
    ...
    en: {
      ...
      "privacy.s.cookies": "<h2>Cookies & tracking</h2><p>We don't use tracking cookies, pixels or third-party analytics. The app stores data only in your browser's <strong>localStorage/IndexedDB</strong> so it can work — not to track you across sites.</p>",
