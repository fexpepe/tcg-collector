...
window.TCG_MESSAGES.pt = Object.assign(window.TCG_MESSAGES.pt || {}, {
      ...
      "binders.page.removeHint": "Remove a página {n} e as cartas dela",
      "binders.page.pair": "Páginas {a}–{b}",
      "binders.book": "Fichário aberto",
      "binders.pagesCount": "{n} página(s)",
      "binders.backToList": "← Binders",
      "binders.configure": "Configurar",
      "binders.panelClose": "Fechar",
      "binders.sheet.where": "Página {p} · bolso {n}",
      "binders.sheet.markOwned": "Marcar que tenho",
      "binders.sheet.want": "Lista de desejo",
      "binders.sheet.wanted": "Na lista de desejo",
      "binders.sheet.view": "Ver carta",
      "binders.sheet.change": "Trocar carta",
      "binders.values": "Valores",
      "binders.contactPlaceholder": "Contato (WhatsApp, @ do Instagram…)",
      ...
      "binders.exportImage": "Exportar imagem",
      ...
      "binders.editor.game": "Jogo:",
      "binders.editor.loadingCatalog": "Carregando catálogo…",
      "binders.editor.noResults": "Nenhuma carta encontrada.",
      "binders.editor.count.one": "{n} carta encontrada",
      "binders.editor.count.other": "{n} cartas encontradas",
...
window.TCG_MESSAGES.en = Object.assign(window.TCG_MESSAGES.en || {}, {
      ...
      "binders.page.removeHint": "Removes page {n} and its cards",
      "binders.page.pair": "Pages {a}–{b}",
      "binders.book": "Open binder",
      "binders.pagesCount": "{n} page(s)",
      "binders.backToList": "← Binders",
      "binders.configure": "Settings",
      "binders.panelClose": "Close",
      "binders.sheet.where": "Page {p} · pocket {n}",
      "binders.sheet.markOwned": "Mark as owned",
      "binders.sheet.want": "Wishlist",
      "binders.sheet.wanted": "On wishlist",
      "binders.sheet.view": "View card",
      "binders.sheet.change": "Change card",
      "binders.values": "Value",
      "binders.contactPlaceholder": "Contact (WhatsApp, Instagram @…)",
      ...
      "binders.exportImage": "Export image",
      ...
      "binders.editor.game": "Game:",
      "binders.editor.loadingCatalog": "Loading catalog…",
      "binders.editor.noResults": "No cards found.",
      "binders.editor.count.one": "{n} card found",
      "binders.editor.count.other": "{n} cards found",
...
window.TCG_MESSAGES.es = Object.assign(window.TCG_MESSAGES.es || {}, {
      ...
      "binders.page.removeHint": "Elimina la página {n} y sus cartas",
      "binders.page.pair": "Páginas {a}–{b}",
      "binders.book": "Binder abierto",
      "binders.pagesCount": "{n} página(s)",
      "binders.backToList": "← Binders",
      "binders.configure": "Configurar",
      "binders.panelClose": "Cerrar",
      "binders.sheet.where": "Página {p} · bolsillo {n}",
      "binders.sheet.markOwned": "Marcar que la tengo",
      "binders.sheet.want": "Lista de deseos",
      "binders.sheet.wanted": "En la lista de deseos",
      "binders.sheet.view": "Ver carta",
      "binders.sheet.change": "Cambiar carta",
      "binders.values": "Valores",
      "binders.contactPlaceholder": "Contacto (WhatsApp, @ de Instagram…)",
      ...
      "binders.exportImage": "Exportar imagen",
